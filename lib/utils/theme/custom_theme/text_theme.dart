...
class AppTextTheme{
  ...
  static TextTheme lighTextTheme =TextTheme(
    ...
    headlineMedium: const TextStyle().copyWith(fontSize: 24, fontWeight: FontWeight.w900, color: Colors.black),
    headlineSmall: const TextStyle().copyWith(fontSize: 19, fontWeight: FontWeight.w600, color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    headlineMedium: const TextStyle().copyWith(fontSize: 24, fontWeight: FontWeight.w900, color: Colors.white),
    headlineSmall: const TextStyle().copyWith(fontSize: 19, fontWeight: FontWeight.w600, color: Colors.white),
